                ...
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle {{ request()->routeIs('public.profil') ? 'active' : '' }}"
                           ...
                           id="profilDropdownApp"
                           role="button"
                           data-bs-toggle="dropdown"
                           aria-expanded="false">
                            Profil <i class="bi bi-chevron-down nav-chevron"></i>
                        </a>
                        <ul class="dropdown-menu shadow-lg" aria-labelledby="profilDropdownApp">
                            <li>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle {{ request()->routeIs('public.packages*', 'public.addons*') ? 'active' : '' }}"
                           ...
                           id="layananDropdownApp"
                           role="button"
                           data-bs-toggle="dropdown"
                           aria-expanded="false">
                            Layanan <i class="bi bi-chevron-down nav-chevron"></i>
                        </a>
                        <ul class="dropdown-menu shadow-lg" aria-labelledby="layananDropdownApp">
                            <li>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle {{ request()->routeIs('public.faq') ? 'active' : '' }}"
                           ...
                           id="bantuanDropdownApp"
                           role="button"
                           data-bs-toggle="dropdown"
                           aria-expanded="false">
                            Bantuan <i class="bi bi-chevron-down nav-chevron"></i>
                        </a>
                        <ul class="dropdown-menu shadow-lg" aria-labelledby="bantuanDropdownApp">
                            <li>
                            ...
                            <li>
                                <a class="dropdown-item" href="https://wa.me/{{ $waNumber }}?text=Halo%20CS%20FibermediaPlay" target="_blank">
